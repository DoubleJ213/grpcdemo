...
var addr = flag.String("addr", "localhost:10088", "the address to connect to")
...
func main() {
	...
	certificate, err := tls.LoadX509KeyPair("demo3/client.crt", "demo3/client.key")
	if err != nil {
		log.Fatal(err)
	}
	...
	callUnaryEcho(proto2.NewEchoClient(conn), "hello demo3")
}
